  ...
  <div class="chemical-view">
    <div class="flex flex-col flex-grow items-start justify-between px-4">
      <div v-for="(chem, $chemId) of chemical.ingredients" :key="$chemId">
        ...
        <div></div>
        <div v-if="chem.state == 'solid'" class="font-black">Details:
          <div class="font-medium pr-2">  - Weight:
            <input
        ...
        <div v-else-if ="chem.state == 'solution'" class="font-black">Details:
          <div class="font-medium pr-2"> - Solvent:
            <input
              class = "w-20 min-w-0 text-xs"
          ...
          <div class="font-medium pr-2"> - Concentration:
            <input
              class = "w-20 min-w-0 text-xs"
          ...
          <div class="font-medium pr-2"> - Volume:
            <input
              class = "w-20 min-w-0 text-xs"
        ...
        <div v-else-if ="chem.state == 'liquid'" class="font-black">Details:
          <div class="font-medium pr-2">- Weight:
            <input
              class = "w-20 min-w-0 text-xs"
              placeholder ="Enter weight"
        ...
        <div v-else-if ="chem.state == 'gas'" class="font-black">Details:
          <div class="font-medium pr-2">- Volumn:
            <input
              class = "w-20 min-w-0 text-xs"
              placeholder ="Enter volume"
              type="text"
          ...
          <div class="font-medium pr-2">- Pressure:
            <input
              class = "w-20 min-w-0 text-xs"
        ...
        <div v-else class="font-black">Details:
